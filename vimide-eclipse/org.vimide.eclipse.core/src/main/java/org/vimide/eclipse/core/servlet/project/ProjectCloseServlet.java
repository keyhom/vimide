...
/**
 * Request to close projects.
 * 
 * @author keyhom (keyhom.c@gmail.com)
 */
@WebServlet(urlPatterns = "/project_close")
public class ProjectCloseServlet extends GenericVimideHttpServlet {

    private static final long serialVersionUID = 1L;
    static final Logger LOGGER = LoggerFactory
            .getLogger(ProjectCloseServlet.class);
        ...
        for (IProject project : projects) {
            ...
            if (project.exists()) {
                try {
                    ...
                    sb.append(NLS.bind(CoreMessages.project_closed,
                            project.getName()));
                } catch (CoreException e) {
                    LOGGER.error("Project '{}' closed failed: {}",
                            project.getName(), e.getMessage(), e);
                    sb.append(NLS.bind(CoreMessages.project_op_failed,
                            "Closing", project.getName()));
                }
            } else {
